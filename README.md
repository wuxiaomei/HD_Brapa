...
1. https://drive.google.com/file/d/1qLo7xCcjlg3G-59LpQMZTniTfSNniatE/view?usp=drive_link
...
1. From https://github.com/rlrq/HDstress
1. Supplemental Figures S6: Gene counts of GO terms mapped via orthologous families with different normalisation methods against counts of GO terms mapped via A. thaliana orthologue identified by BLAST.
1. Supplemental Figure S7: GO enrichment analysis of all B. rapa genes with different mapping methods and universes.
1. Supplemental Figure S8: GO enrichment analysis of treatment DEGs (HD-responsible genes) with different mapping methods and universes.
